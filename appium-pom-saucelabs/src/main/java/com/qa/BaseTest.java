...
public class BaseTest {
	...
	public synchronized void afterMethod(ITestResult result) throws Exception {
		...
		String dirPath = System.getProperty("outputFolder") + File.separator + new BaseTest().getDateStr()
				+ File.separator + "videos" + File.separator + params.get("platformName") + "_"
				+ params.get("deviceName") + File.separator + result.getTestClass().getRealClass().getSimpleName();
		...
		try {
			stream = new FileOutputStream(
					videoDir + File.separator + result.getName() + "_" + new BaseTest().getDateTime() + ".mp4");
	...
	/*
	 * @BeforeSuite public void beforeSuite() throws Exception, Exception {
	 * ThreadContext.put("ROUTINGKEY", "ServerLogs"); server =
	 * getAppiumServerDefault(); if (!checkIfAppiumServerIsRunnning(4723)) {
	 * server.start(); server.clearOutPutStreams();
	...
	public void beforeSuite() throws Exception {
		ThreadContext.put("ROUTINGKEY", System.getProperty("outputFolder") + File.separator + "ServerLogs");
...
//	}
	...
	public AppiumDriverLocalService getAppiumService() {
		...
		environment.put("PATH",
				"/Library/Internet Plug-Ins/JavaAppletPlugin.plugin/Contents/Home/bin:/Users/ttee/Library/Android/sdk/tools:/Users/tte/Library/Android/sdk/platform-tools:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/Apple/usr/bin"
						+ System.getenv("PATH"));
		environment.put("ANDROID_HOME", "/Users/ttee/Library/Android/sdk");
	...
	public void beforeTest(@Optional("androidOnly") String emulator, String platformName, String udid,
		...
		String strFile = System.getProperty("outputFolder") + File.separator + "logs" + File.separator + platformName
				+ "_" + deviceName;

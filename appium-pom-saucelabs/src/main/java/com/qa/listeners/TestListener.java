...
public class TestListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		String imagePath = System.getProperty("outputFolder") + File.separator + base.getDateStr() + File.separator
				+ "Screenshots" + File.separator + params.get("platformName") + "_" + params.get("deviceName")
	...
	public void onTestStart(ITestResult result) {
		...
		ExtentReport.startTest(result.getName(), result.getMethod().getDescription())
				.assignCategory(base.getPlatform() + "_" + base.getDeviceName()).assignAuthor("Vinay Babu Gutta");
	}
